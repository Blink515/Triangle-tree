...
// Gradient palette "es_rosa_51_gp", originally from
// http://soliton.vm.bytemark.co.uk/pub/cpt-city/es/rosa/tn/es_rosa_51.png.index.html
// converted for FastLED with gammas (2.6, 2.2, 2.5)
// Size: 16 bytes of program space.

DEFINE_GRADIENT_PALETTE( es_rosa_51_gp ) {
    0,  13,  0,  2,
  101,  32,  0,  6,
  204,  60,115,  1,
  255, 118,157,  1};
...
// Gradient palette "kenyan_17_gp", originally from
// http://soliton.vm.bytemark.co.uk/pub/cpt-city/gacruxa/kenyan/tn/kenyan-17.png.index.html
// converted for FastLED with gammas (2.6, 2.2, 2.5)
// Size: 48 bytes of program space.

DEFINE_GRADIENT_PALETTE( kenyan_17_gp ) {
    0, 115,130,119,
    0, 237,239,237,
   24, 237,239,237,
   25,  28,  1, 67,
